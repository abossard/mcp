...
namespace Azure.Mcp.Tools.HealthModels.Options.Relationship;

public sealed class RelationshipCreateOptions : ISubscriptionOption
{
    [Option(Description = HealthModelsOptionDefinitions.HealthModel)]
    public required string HealthModel { get; set; }

    [Option(Description = HealthModelsOptionDefinitions.Relationship)]
